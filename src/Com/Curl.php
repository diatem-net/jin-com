...
class Curl
{
   ...
   * @param  string        $requestType        (optional) Type de requête. (POST, GET, DELETE ou PUT) (POST par défaut)
   * @param  boolean       $throwError         (optional) Génère les erreurs directement (True par défaut)
   * @param  string        $contentType        (optional) Header 'Content-type'. Par défaut : application/json
